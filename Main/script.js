...
function fetchInfo() {
    ...
    infoContent.innerHTML = `
        ...
        <p>Hurricane Alert: Category 4 hurricane approaching the coastline. Evacuation orders in place.</p>
        <p>Flood Warning: Heavy rainfall expected in the next 24 hours. Stay indoors and avoid low-lying areas.</p>
    `;
}
...
function fetchEducation() {
    ...
    educationContent.innerHTML = `
        ...
        <ul>
            <li>Build an emergency kit with essentials.</li>
            <li>Make a family communication plan.</li>
            <li>Learn first aid and CPR.</li>
            <li>Stay informed about local disaster risks.</li>
        </ul>
    `;
}
